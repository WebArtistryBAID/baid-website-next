<template>
  <div>
    <div
      ...
      class="w-5 h-7 ml-2 mr-10 op-50 hover:op-100 active:op-80 transition text-inherit"
      placeholder="Search"
      type="text"
      ...
      >
        ...
        >
          <RouterLink
            ...
            class="text-black decoration-none op-80 hover:op-100 transition"
            @click="toggleSearchBox()"
          >
            <h3 class="m0">
