<template>
  ...
  >
    <div class="m-l-10">
      <SchoolLogo
        :color="color"
        :logo-type="route.meta.header && route.meta.header.logoType"
      />
    </div>
    ...
    <div class="flex h-full m-r-10 items-center">
      ...
      <svg
        ...
        class="lg:hidden block op-50 hover:op-100 active:op-80 transition-all text-inherit"
        height="32"
        viewBox="0 0 24 24"
        width="32"
        @click="expand = !expand"
      ...
      <p class="w-7 text-center">
        <router-link
          ...
          "
          class="decoration-none opacity-50 transition-colors transition-opacity text-inherit hover:opacity-100 active:opacity-80"
        >
          <svg
            class="w-6 h-10"
            height="32"
